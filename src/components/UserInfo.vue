...
const percentage = computed(() => {
    ...
    return Math.floor(summonerStore.currentSummoner.xpSinceLastLevel / summonerStore.currentSummoner.xpUntilNextLevel * 100);
})
...
<template>
    <div class="self" @click="update">
        <div class="icon">
            <el-image class="img"
                :src="`https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/profile-icons/${profileIconId}.jpg`"></el-image>
        ...
        <div class="info">
            ...
            <el-progress :percentage="percentage" :show-text="false" :stroke-width="10" striped striped-flow />
        </div>
    </div>
</template>
