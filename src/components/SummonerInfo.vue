  ...
  <div class="self">
    <div class="profile">
      <el-skeleton :loading="!ready" :animated="true">
        ...
        <template #default>
          <div class="icon">
            {{ summonerStore.querySummoner!.profileIconId }}
            <img
        ...
        <template #default>
          <div class="card-body">
            ...
            <div class="rank-level">
              <div class="level">
                <span class="tier">soloRankTier-{{ soloRankTier }}</span>
                <span class="division"
                  >soloRankDivision-{{ soloRankDivision }}</span
                >
              </div>
              <div class="lp">
                <span>soloLp-{{ soloLp }}</span
                >LP
              </div>
            </div>
            <div class="win-lose">
              soloWin-{{ soloWin }}胜soloLose-{{ soloLose }}负
              <br />
              胜率-{{ soloWinRate }}%soloWinRate
            </div>
          </div>
        </template>
      </el-skeleton>
      ...
      <el-skeleton :loading="!ready" :animated="true">
        ...
        <template #default>
          <div class="card-body">
            ...
            <div class="rank-level">
              <div class="level">
                <span class="tier">flexRankTier-{{ flexRankTier }}</span>
                <span class="division"
                  >flexRankDivision-{{ flexRankDivision }}</span
                >
              </div>
              <div class="lp">
                <span>flexLp-{{ flexLp }}</span
                >LP
              </div>
            </div>
            <div class="win-lose">
              flexWin flexLose -{{ flexWin }}胜-{{ flexLose }}负
              <br />
              flexWinRate 胜率-{{ flexWinRate }}%
            </div>
          </div>
        </template>
      </el-skeleton>
